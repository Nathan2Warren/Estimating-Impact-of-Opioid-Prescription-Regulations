...
policy_year = 2010
os.chdir('C:/Users/Jiajie Zhang/IDS_mid_project/Intermediate_data')
os.getcwd()
...
#read in Census data
Census_full = pd.read_csv('./Census_Full_State_Level.csv')
...
geom_smooth(Opioid_Mort_Census.loc[(Opioid_Mort_Census['Year']>=policy_year) & (Opioid_Mort_Census['Is_Target_State']==False)], aes( x = 'Year', y = 'MME_Per_Capita'), method = 'lm', color = "black") +
geom_smooth(Opioid_Mort_Census.loc[(Opioid_Mort_Census['Year']<=(policy_year-1)) & (Opioid_Mort_Census['Is_Target_State']==False)], aes( x = 'Year', y ='MME_Per_Capita'), method = 'lm',color = "black") +
geom_smooth(Opioid_Mort_Census.loc[(Opioid_Mort_Census['Year']>=policy_year) & (Opioid_Mort_Census['Is_Target_State']==True)], aes( x = 'Year', y = 'MME_Per_Capita'), method = 'lm',color = "blue") +
geom_smooth(Opioid_Mort_Census.loc[(Opioid_Mort_Census['Year']<=(policy_year-1)) & (Opioid_Mort_Census['Is_Target_State']==True)], aes( x = 'Year', y ='MME_Per_Capita'), method = 'lm',color = "blue") +
...
ggtitle('FL Opioid Diff-in-Diff Analysis')
#ylim(0,1)
)
(ggsave(filename = 'FL_DiD_Analysis',plot = p,width =12, height = 8))
